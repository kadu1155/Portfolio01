        ...
        >
          ...
          <div className="relative">
            ...
            <div className="grid sm:grid-cols-2 gap-4 max-w-xl mx-auto mb-8">
              ...
              <a href="https://www.linkedin.com/in/kadambari-galinde-3bb322330" target="_blank" rel="noreferrer" className="glass rounded-2xl p-4 flex items-center gap-3 hover:bg-white/10 transition-colors text-left">
